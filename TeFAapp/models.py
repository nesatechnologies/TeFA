...
class Lead(models.Model):
    ...
    lead_no = models.CharField(max_length=50, blank=True, null=True, validators=[alphanumeric])
    name = models.CharField(max_length= 50, blank=True)
    course_type = models.CharField(max_length=20, blank=True, default="")
    ...
    degree = models.CharField(max_length=250, blank=True, default='')
    def __str__(self):
